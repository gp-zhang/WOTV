...
- (void)viewDidLoad {
	...
	_menuTableView.autoresizingMask = UIViewAutoresizingFlexibleHeight|UIViewAutoresizingFlexibleBottomMargin;
...
- (void)viewDidLayoutSubviews {
    if ([self respondsToSelector:@selector(topLayoutGuide)]) {
        ...
        self.view.frame = CGRectMake(viewBounds.origin.x, topBarOffset,
                                      viewBounds.size.width, viewBounds.size.height - topBarOffset);
    }
}
